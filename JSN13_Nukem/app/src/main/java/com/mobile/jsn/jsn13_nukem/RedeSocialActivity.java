...
public class RedeSocialActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rede_social, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_redesocial_retorno) {
            Intent i = new Intent(this.getApplicationContext(),PrincipalActivity.class);
            startActivity(i);

        } else if (id == R.id.nav_comentarios) {

            Intent i = new Intent(this.getApplicationContext(),ComentarioActivity.class);
            startActivity(i);
